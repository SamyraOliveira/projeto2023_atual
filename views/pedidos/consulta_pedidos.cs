...
namespace projeto2023.views.pedidos
{
    public partial class consulta_pedidos : Form
    {
        ...
        private void consulta_pedidos_Load(object sender, EventArgs e)
        {
            ...
            this.colaboradoresTableAdapter.Fill(this.estampariadbDataSet1.Colaboradores);
        ...
        private void pnl_detalhespedido_Paint(object sender, PaintEventArgs e)
        {

        }

        private void cbx_inativos_Pedidos_CheckedChanged(object sender, EventArgs e)
        {
        }
    }
